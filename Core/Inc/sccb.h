...
#define SCCB_SCL_GPIO_CLK_ENABLE()	__HAL_RCC_GPIOB_CLK_ENABLE()
#define SCCB_SCL_GPIO_CLK_DISABLE()	__HAL_RCC_GPIOB_CLK_DISABLE()
...
#define SCCB_SDA_GPIO_CLK_ENABLE()	__HAL_RCC_GPIOB_CLK_ENABLE()
#define SCCB_SDA_GPIO_CLK_DISABLE()	__HAL_RCC_GPIOB_CLK_DISABLE()

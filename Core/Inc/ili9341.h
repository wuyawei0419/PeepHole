...
//HAL_GPIO_WritePin(ILI9341_DB8_GPIO_PORT, ILI9341_DB8_GPIO_PIN, (GPIO_PinState)(data&(0x01 << 0)));\
...
#define ILI9341_RS_WRITE(PinState)					(PinState == 0)?(ILI9341_RS_GPIO_PORT->BRR = (uint32_t)ILI9341_RS_GPIO_PIN):(ILI9341_RS_GPIO_PORT->BSRR = (uint32_t)ILI9341_RS_GPIO_PIN);
#define ILI9341_WR_WRITE(PinState)					(PinState == 0)?(ILI9341_WR_GPIO_PORT->BRR = (uint32_t)ILI9341_WR_GPIO_PIN):(ILI9341_WR_GPIO_PORT->BSRR = (uint32_t)ILI9341_WR_GPIO_PIN);
#define ILI9341_RD_WRITE(PinState)					(PinState == 0)?(ILI9341_RD_GPIO_PORT->BRR = (uint32_t)ILI9341_RD_GPIO_PIN):(ILI9341_RD_GPIO_PORT->BSRR = (uint32_t)ILI9341_RD_GPIO_PIN);
#define ILI9341_CS_WRITE(PinState)					(PinState == 0)?(ILI9341_CS_GPIO_PORT->BRR = (uint32_t)ILI9341_CS_GPIO_PIN):(ILI9341_CS_GPIO_PORT->BSRR = (uint32_t)ILI9341_CS_GPIO_PIN);
#define ILI9341_REST_WRITE(PinState)				(PinState == 0)?(ILI9341_REST_GPIO_PORT->BRR = (uint32_t)ILI9341_REST_GPIO_PIN):(ILI9341_REST_GPIO_PORT->BSRR = (uint32_t)ILI9341_REST_GPIO_PIN);

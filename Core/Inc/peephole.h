...
#define SN74LV125_OE_GPIO_PIN							GPIO_PIN_4
...
#define SN74LV245_OE_GPIO_PIN							GPIO_PIN_4
...
#define OV_VSYNC_GPIO_PIN							GPIO_PIN_4
#define OV_VSYNC_GPIO_CLK_ENABLE()		__HAL_RCC_GPIOB_CLK_ENABLE()
#define OV_VSYNC_GPIO_CLK_DISABLE()		__HAL_RCC_GPIOB_CLK_DISABLE()
...
#define POWER_GPIO_PIN						GPIO_PIN_4
